...
async function seed() {
  ...
  await roles.insert({
    ...
    privileges: encodePrivileges({
      ...
      expenses: { read: true, create: true, update: true, delete: true, actions: ['upload'] },
      ...
      notebooks: { read: true, create: true, update: true, delete: true, actions: ['upload'] },
      dailyPlans: { read: true, create: true, update: true, delete: true, actions: ['upload'] },
